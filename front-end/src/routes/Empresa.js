...
export default function Empresa(){
    return(
        <div className="h-screen bg-branco flex flex-col md:flex-row justify-evenly items-center">
            <div className="lg:w-5/12 flex flex-col justify-center items-center mr-8 lg:mr-10">
                <h1 className="text-center text-5xl text-vermelho font-bold lg:mt-0 mt-10">Sobre nós</h1>
